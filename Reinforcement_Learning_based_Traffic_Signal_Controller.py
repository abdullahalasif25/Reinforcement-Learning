...
# Defining the action space (phase and green time combinations)
...
# Defining the state space (queue lengths for each approach)
...
def get_state(queue_lengths):
    return int(sum(queue_lengths) // 10)  
